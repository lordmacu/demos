...
class SliderWidgetDeactivated extends StatefulWidget {
...
class _SliderWidgetOnSavedState extends State<SliderWidgetDeactivated> {
  // double _min = 0.0;
