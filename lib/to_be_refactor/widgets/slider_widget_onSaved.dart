...
class SliderWidgetOnSaved extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SliderWidgetOnSavedState();
}

class _SliderWidgetOnSavedState extends State<SliderWidgetOnSaved> {
  // double _min = 0.0;
  ...
  Widget build(BuildContext context) {
    ...
    if (_valueNumber > widget.min) {
      if (_valueNumber > widget.max) {
        ...
        setState(() {
          var numberDouble =
              _valueNumber.toStringAsFixed(widget.isColombia ? 0 : 2);
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(S.of(context).youCuote, style: AppTextStyles.normal4),
          SizedBox(
  ...
  Widget _createSlider() {
    var formater = widget.isColombia
        ? NumberFormaters.copFormater
        : NumberFormaters.mxFormater;
            ...
            child: Slider(
              ...
              onChangeEnd: (value) {
                ...
                if (_setValue >= _min) {
                  setState(() {
                    String doubleNumber =
                        _setValue.toStringAsFixed(widget.isColombia ? 0 : 2);
    ...
    return Column(
      ...
      children: <Widget>[
        CustomTextFormField(
          ...
          onChanged: (value) {
            double dValue = widget.controller.numberValue;
            setState(() {
              _valueNumber = dValue;
            });
          },
