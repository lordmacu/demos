...
class BubbleDrawer extends CustomPainter {
  BubbleDrawer({
    this.radius,
    this.nip,
    this.nipWidth,
...
//        assert(radius <= nipHeight + nipOffset),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    switch (nip) {
      ...
      case BubbleNip.leftBottom:
        ...
        path.addPath(path2, Offset(0, 0));
        canvas.drawPath(path, paint); // Magic!
        break;
  ...
  @override
  bool shouldRepaint(BubbleDrawer oldDelegate) => true;
}
...
class CustomBubble extends StatelessWidget {
  CustomBubble({
    ...
    Color borderColor,
        ...
        bubbleDrawer = BubbleDrawer(
          borderColor: borderColor ?? Colors.transparent,
          radius: radius ?? style?.radius ?? Radius.circular(20.0),
  ...
  final BubbleDrawer bubbleDrawer;
  final Color borderColor;
