...
class PSEInvestmentTimeDialog extends StatelessWidget {
  final Function acceptCallBack;
  final Function undoCallback;

  const PSEInvestmentTimeDialog(
      {Key key, this.acceptCallBack, this.undoCallback})
      : super(key: key);
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              S.of(context).pseTimeDialogDescription1,
            ...
            Text(
              S.of(context).pseTimeDialogDescription2,
              style: AppTextStyles.normal1.copyWith(
                color: AppColors.g75Color,
                fontWeight: FontWeight.w400,
              ),
